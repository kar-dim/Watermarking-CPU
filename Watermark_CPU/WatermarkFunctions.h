...
public:
	...
	Eigen::ArrayXXf make_and_add_watermark_ME();
...
private:
	...
	void compute_ME_mask(const Eigen::ArrayXXf& image, const Eigen::ArrayXXf& padded_image, Eigen::ArrayXXf& m, Eigen::ArrayXXf& error_sequence, Eigen::MatrixXf& coefficients, const bool mask_needed);
	void compute_error_sequence(const Eigen::ArrayXXf& image, Eigen::MatrixXf& coefficients, Eigen::ArrayXXf& error_sequence);
};